...
TASK: Analyse the current portfolio and market conditions. Return ONLY a JSON object with this exact structure:
{{
  "regime_assessment": "brief sentence",
  "actions": [
    {{
      ...
      "stop_price": 0.0,
      "take_profit": 0.0,
      "reasoning": "clear concise reason"
    }}
  ],
  "risk_notes": "any risk flags",
  "commentary": "2-3 sentence PM summary of this evaluation cycle"
}}

Only include actions where something should actually happen. If everything looks fine, return an empty actions array with commentary explaining why no trades are needed.
